...
const Page = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-800 to-gray-900 text-white px-4">
      <div className="w-full max-w-4xl mx-auto p-6 sm:p-8 bg-black/60 backdrop-blur-md rounded-3xl shadow-lg">
        {/* Header Section */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-6 text-indigo-300">
          Aura Help Desk
        </h1>
        <p className="text-center text-sm sm:text-base text-gray-300 mb-8 sm:mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          {/* Card 2 */}
          <div className="p-6 bg-gradient-to-r from-indigo-800 to-purple-700 rounded-2xl shadow-lg">
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">Submit a Ticket</h2>
            <p className="text-sm text-gray-300">
          ...
          {/* Card 3 */}
          <div className="p-6 bg-gradient-to-r from-indigo-800 to-purple-700 rounded-2xl shadow-lg">
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">Live Chat</h2>
            <p className="text-sm text-gray-300">
        ...
        <div className="mt-10 text-center">
          <h3 className="text-lg sm:text-xl font-medium mb-4">Important Notes</h3>
          <ul className="text-sm sm:text-base text-gray-300 list-disc list-inside">
